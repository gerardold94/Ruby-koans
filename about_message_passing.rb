...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Answer: The send method can be overridden by some classes
    # where that method does not behave like the original,
    # for these cases ruby provides the method __send__.
  end
