...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Answer: inject iterates over the members of an array.
    # While doing so, it performs the block function
    # on each subsequent value within the array.
    # The argument is the initial value on which the
  ...
  #   # code to read 'file'
  #
  # Answer: the scope of the open file is limited to that block,
  # and it is closed when the block completes.
  #
